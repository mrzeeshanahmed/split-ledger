...
const plans = [
    {
        ...
        price: '0%',
        period: 'Platform Fee',
        description: 'Perfect for testing our APIs and integrating Webhooks.',
    ...
    },
    {
        ...
        price: '2.5%',
        period: '+ Stripe fees',
        description: 'Pay-as-you-grow commission model. We only make money when you do.',
        features: ['Unlimited API calls', '100% SLA Guarantee', 'Instant Webhook Delivery', 'Priority Support', 'Full Stripe Connect access', 'Advanced Analytics'],
    ...
    },
    {
        ...
        description: 'For high-volume platforms processing >$100k/mo.',
